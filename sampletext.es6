...
export default class SampleText extends React.Component {
    render() { return (
<section>
<div className="step-3 flight">Very sampli'ish flight</div>

<div className="step-7 heading">step 7 Fingerstache nesciunt lomo nostrud hoodie</div>

<div className="step-6 heading">step 6 Kitsch retro lewhi föiwehf öweihf oweih föwehjkwefkjwekfwe</div>

<div className="step-5 heading">step 5 Typewriter delectus cred</div>

<div className="step-4 heading">step 4 Fingerstache nesciunt lomo nostrud hoodie</div>

<div className="step-3 heading">step 3 Kitsch retro lewhi föiwehf öweihf oweih föwehjkwefkjwekfwe</div>
...
<div className="step-0 heading">step 0 Fingerstache nesciunt lomo nostrud hoodie</div>



<div className="step--1 heading">step -1 Truffaut disrupt sartorial deserunt</div>

<div className="step--2 heading">step -2 Fingerstache nesciunt lomo nostrud hoodie</div>
...
<div className="step-3 italic">step-3 Kitsch retro lewhi föiwehf öweihf oweih föwehjkwefkjwekfwe</div>
...
<div className="step-0 italic">step-0 Fingerstache nesciunt lomo nostrud hoodie</div>





<div className="step-3">step-3 Kitsch retro lewhi föiwehf öweihf oweih föwehjkwefkjwekfwe</div>
